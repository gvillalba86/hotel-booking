...
df.resort %>%
  ...
  geom_boxplot()+
  labs(x="Régimen de alojamiento", y="Coste medio por noche")+
...
Podemos ver que los residuos no se ajustan bien a la normal, por lo que esta condición no se cumpliría. Es cierto que ANOVA es bastante resistentes a desviaciones considerables de la normalidad, especialmente cuando tenemos muestras grandes, como es nuestro caso. Sin embargo, las desviaciones que vemos son bastantes grandes. Realizamos un histograma para ver la distribución de estos residuos.
